...
_lr_productions = [
  ...
  ('FUN_CALL -> lpr FUN_EXP rpr','FUN_CALL',3,'p_FUN_CALL_exp_no_param','yacc.py',248),
  ('FUN_CALL -> lpr FUN_EXP PARAM_PLUS rpr','FUN_CALL',4,'p_FUN_CALL_exp_params','yacc.py',252),
  ('FUN_CALL -> lpr FUN_NAME rpr','FUN_CALL',3,'p_FUN_CALL_name_no_param','yacc.py',260),
  ('FUN_CALL -> lpr FUN_NAME PARAM_PLUS rpr','FUN_CALL',4,'p_FUN_CALL_name_params','yacc.py',264),
  ('PARAM -> EXP','PARAM',1,'p_PARAM','yacc.py',273),
  ('PARAM_PLUS -> PARAM','PARAM_PLUS',1,'p_PARAM_PLUS_one','yacc.py',276),
  ('PARAM_PLUS -> PARAM PARAM_PLUS','PARAM_PLUS',2,'p_PARAM_PLUS_more','yacc.py',279),
  ('FUN_NAME -> id','FUN_NAME',1,'p_FUN_NAME','yacc.py',283),
  ('IF_EXP -> lpr if_ TEST_EXP THEN_EXP ELSE_EXP rpr','IF_EXP',6,'p_IF_EXP','yacc.py',287),
  ('TEST_EXP -> EXP','TEST_EXP',1,'p_TEST_EXP','yacc.py',296),
  ('THEN_EXP -> EXP','THEN_EXP',1,'p_THEN_EXP','yacc.py',300),
  ('ELSE_EXP -> EXP','ELSE_EXP',1,'p_ELSE_EXP','yacc.py',304),
]
